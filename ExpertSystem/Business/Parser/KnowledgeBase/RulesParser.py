...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("\3\5\3\6\3\6\3\6\3\6\3\6\3\6\3\6\3\6\3\6\3\6\3\6\5\6@")
...
class RulesParser ( Parser ):
    ...
    class Single_ruleContext(ParserRuleContext):
        ...
        def WITH(self):
            return self.getToken(RulesParser.WITH, 0)
    ...
    class ComparisonExpressionContext(Left_logical_exprContext):
        ...
        def LSPAREN(self):
            return self.getToken(RulesParser.LSPAREN, 0)
        def DECIMAL(self):
            return self.getToken(RulesParser.DECIMAL, 0)
        def RSPAREN(self):
            return self.getToken(RulesParser.RSPAREN, 0)
    ...
    def left_logical_expr(self, _p:int=0):
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.function_expr()
                self.state = 53
                self.match(RulesParser.LSPAREN)
                self.state = 54
                self.match(RulesParser.DECIMAL)
                self.state = 55
                self.match(RulesParser.RSPAREN)
                pass
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = RulesParser.LogicalExpressionAndContext(self, RulesParser.Left_logical_exprContext(self, _parentctx, _parentState))
                        ...
                        self.state = 65
                        self.left_logical_expr(6)
                        pass

                    elif la_ == 2:
                        localctx = RulesParser.LogicalExpressionOrContext(self, RulesParser.Left_logical_exprContext(self, _parentctx, _parentState))
                        self.pushNewRecursionContext(localctx, _startState, self.RULE_left_logical_expr)
                        self.state = 66
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    if self._parseListeners is not None:
                        self.triggerExitRuleEvent()
                    _prevctx = localctx
                    localctx = RulesParser.RLogicalExpressionAndContext(self, RulesParser.Right_logical_exprContext(self, _parentctx, _parentState))
